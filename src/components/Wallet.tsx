...
const Wallet: React.FC<IconProps> = ({
  ...
  return (
    ...
    >
      ...
      {isDuotone && secondaryColor && (
        <defs>
          <linearGradient id="duotone-Wallet" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor={color || 'currentColor'} />
            <stop offset="100%" stopColor={secondaryColor} />
          </linearGradient>
        </defs>
      )}
      <g fill={isDuotone ? `url(#duotone-Wallet)` : undefined}>
  ...
  <path  d="M22 10h-3c-1.1 0-2 .9-2 2s.9 2 2 2h3" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
