...
const Bell: React.FC<IconProps> = ({
  ...
  return (
    ...
    >
      ...
      {isDuotone && secondaryColor && (
        <defs>
          <linearGradient id="duotone-Bell" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor={color || 'currentColor'} />
            <stop offset="100%" stopColor={secondaryColor} />
          </linearGradient>
        </defs>
      )}
      <g fill={isDuotone ? `url(#duotone-Bell)` : undefined}>
  ...
  <path
    ...
    stroke="currentColor" />
  <path  d="M10.41 20.354c.196.245.766.737 1.475.737.708 0 1.279-.492 1.475-.738" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
